...
void input_user()
{
	...
	for (int i = 0; i < 9; i++)			 // Taking input of username , password     - you can customize the loop for how many students you put
	{
		cout << "Enter Username: ";
		cin >> username;
...
void input_record()
{
	...
	for (int i = 0; i < 9; i++)	 // Taking input of student Record     -     you can customize the loop for how many students you put
	{
		cout << "Enter Username: ";
		cin >> username;
		input_data << username << "\t";
